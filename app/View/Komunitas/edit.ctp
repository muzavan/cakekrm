...
<?php echo $this->Form->create('Komunita'); ?>
	<fieldset>
		<legend><?php echo __('Edit Komunita'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Komunita.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Komunita.id')))); ?></li>
...
<script>
	...
	function initialize() {
	        ...
	        var pos= new google.maps.LatLng(e.latLng.A,e.latLng.F);
	            ...
	            $('#KomunitaLat').val(e.latLng.A.toFixed(5));
	            $('#KomunitaLng').val(e.latLng.F.toFixed(5));
	        });
	}
