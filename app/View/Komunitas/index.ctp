<div class="komunitas index">
	...
	<tbody>
	<?php foreach ($komunitas as $komunita): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $komunita['Komunita']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $komunita['Komunita']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
